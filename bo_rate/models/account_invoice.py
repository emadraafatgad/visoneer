...
class account_invoice(models.Model):
    ...
    def check_currency_id(self):
        if self.manual_currency_rate_active:
            if self.currency_id == self.company_id.currency_id:
                ...
                raise UserError(
                    _('Company currency and invoice currency same, You can not added manual Exchange rate in same currency.'))
    ...
    def _onchange_rate_currency(self):
        print("aim in onchange")
        if self.manual_currency_rate_active and self.manual_currency_rate:
            for line in self.line_ids:
                # line._get_fields_onchange_subtotal_model()
